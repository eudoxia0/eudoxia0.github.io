...
values. The "Hello, world!" of flashcards is the [NATO phonetic alphabet][nato]:
...
with language: you already have a [language center][lc], you just need to drill
...
In general, _relational_ facts are easier to encode, since a binary predicate
like $\text{Property}(\text{Object}, \text{Value})$ readily becomes a
question. "Caffeine is metabolized by [cytochrome 1A2][1a2]", in
[Prolog][prolog], is $\text{Metabolism}(\text{Caffeine}, \text{CYP1A2})$, and
becomes "Q: What is the cytochrome that metabolizes caffeine? A: 1A2". But how
do you encode stand-alone assertions like "all [unitary matrices][uni] are
[invertible][inv]"? You could encode that as a yes-or-no question, but that's
...
the AI all kinds of _general_ rules on how to write good flashcards, but the AI
can't look into your mind and know which facts are salient _for you_, what you
...
community are lurkers][lurk]) even fewer of those people are writing, in detail,
to share their knowledge. [Plenty][a] [of][b] [people][c] have written about how
...
[this][mike] from Michael Nielsen. From a corpus of similar case studies we
