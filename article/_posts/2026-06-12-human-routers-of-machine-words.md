...
about the brain, i.e., we can read [mental representations][mr] from recordings
...
would find a [nebulous][egg], contradictory mess of memory and feeling and
...
[Josef Weizenbaum][jw] has a great quote about this, in [_Computer Power and
Human Reason_][book] (p. 108):
...
always more disappointing than the dream, because it was a false dream, and [_ex
falso_][ex] anything can be imagined.
...
writing is the thinking. Writing is the _ne plus ultra_ of thinking. A
...
not, but even if it were, it is [_maddening_][sk] that everywhere you go, you
...
[book]: https://en.wikipedia.org/wiki/Computer_Power_and_Human_Reason
[egg]: https://metarationality.com/
[ex]: https://en.wikipedia.org/wiki/Principle_of_explosion
[jw]: https://en.wikipedia.org/wiki/Joseph_Weizenbaum
[mr]: https://plato.stanford.edu/entries/mental-representation/
[sk]: https://substack.com/@samkriss/p-194751836
