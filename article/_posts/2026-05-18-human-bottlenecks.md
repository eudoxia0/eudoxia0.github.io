...
computing pioneers: [_Augmenting Human Intellect_][ahi], [_Man-Computer
Symbiosis_][mcs]. [Engelbart][eng]'s lab was called the [Augmentation Research
Center][arc]! And more recently, people used to complain about how everyone has
...
[Solow paradox][solow] on an individual level. Why? I think there are two
reasons: first, most people lack what [Andy Matuschak][andy] calls a "[serious
context of use][scus]" (AI doesn't move the needle because there's no needle to
...
[Anki][anki] every day? Have ever used Anki? The people who want an AI that
writes flashcards for them _don't use flashcards_. They have no reason
to. Dually, the people who use flashcards [would benefit little from AI][self]
...
sake of learning is opportunity cost: there is no _a priori_ reason to learn one
...
Would an "AI executive assistant" _actually_ boost your productivity? What would
...
and ask: what _exact_ actions could an AI looking over my shoulder have taken,
...
brain][sb]"---plus an AI agent that writes, edits, synthesizes information,
...
deliverables. The deliverable is you take a screenshot of your [Obsidian][obs]
...
more effective, like Manfred in [_Accelerando_][acc].
...
Consider executive function. [My own experience of managing ADHD][adhd] is the
...
minimum][liebig]). All the pomodoros in the world are as nothing to a little
molecule diffusing through my brain tissue, binding to [NET][net] and
[DAT][dat]. And what scaffolding is useful is just classical software:
[Todoist][todoist] and calendars. Is an agent going to match the effectiveness
...
[centaur][taur] is the human! So intelligence is fixed until we get very
...
can't [rightly apprehend the confusion of ideas][babq] that would lead someone
...
the answers, and you won't ever think to ask. You're in a _completely_ different
...
popular view of [human capital is becoming worthless][hinton], the returns to
education are now _higher_, because intelligent, educated people with working
...
[arc]: https://en.wikipedia.org/wiki/Augmentation_Research_Center
[babq]: https://en.wikiquote.org/wiki/Charles_Babbage#Passages_from_the_Life_of_a_Philosopher_(1864)
[dat]: https://en.wikipedia.org/wiki/Dopamine_transporter
[eng]: https://en.wikipedia.org/wiki/Douglas_Engelbart
[hinton]: https://www.youtube.com/watch?v=2HMPRXstSvQ
[liebig]: https://en.wikipedia.org/wiki/Liebig%27s_law_of_the_minimum
[mcs]: https://en.wikipedia.org/wiki/Man%E2%80%93Computer_Symbiosis
